...
import com.sk89q.worldedit.bukkit.adapter.impl.regen.RegenV16R3;
...
public final class FAWESpigotV16R3 extends CachedBukkitAdapter implements IDelegateBukkitImplAdapter<NBTBase> {
    ...
    public FAWESpigotV16R3() throws NoSuchFieldException, NoSuchMethodException {
    ...
    private synchronized boolean init() {
        ...
        for (int i = 0; i < ibdToStateOrdinal.length; i++) {
            ...
            BlockMaterial material = (BlockMaterial) state.getMaterial();
    ...
    @Override
    public com.sk89q.worldedit.world.registry.BlockMaterial getMaterial(BlockType blockType) {
        Block block = getBlock(blockType);
        return new BlockMaterial(block);
    }

    @Override
    public com.sk89q.worldedit.world.registry.BlockMaterial getMaterial(BlockState state) {
        IBlockData bs = ((CraftBlockData) Bukkit.createBlockData(state.getAsString())).getState();
        return new BlockMaterial(bs.getBlock(), bs);
    }
    ...
    public BaseBlock getBlock(Location location) {
        ...
        BlockState state = com.sk89q.worldedit.bukkit.BukkitAdapter.adapt(bukkitBlock.getBlockData());
    ...
    public boolean setBlock(org.bukkit.Chunk chunk, int x, int y, int z, BlockStateHolder state, boolean update) {
        ...
        IBlockData blockData = ((BlockMaterial) state.getMaterial()).getState();
        ...
        IBlockData existing;
        if (section == null) {
            existing = ((BlockMaterial) BlockTypes.AIR.getDefaultState().getMaterial()).getState();
        } else {
    ...
    public WorldNativeAccess<?, ?, ?> createWorldNativeAccess(org.bukkit.World world) {
        return new FAWEWorldNativeAccess(this,
    ...
    public char adaptToChar(IBlockData ibd) {
        synchronized (this) {
            try {
                ...
                getLogger(FAWESpigotV16R3.class)
    ...
    private MapChunkUtilV16R3 mapUtil = new MapChunkUtilV16R3();
    ...
    public BaseItemStack adapt(org.bukkit.inventory.ItemStack itemStack) {
        ...
        final BaseItemStack weStack = new BaseItemStack(com.sk89q.worldedit.bukkit.BukkitAdapter.asItemType(itemStack.getType()), itemStack.getAmount());
    ...
    public boolean regenerate(org.bukkit.World bukkitWorld, Region region, Extent target, RegenOptions options) throws Exception {
        return new RegenV16R3(bukkitWorld, region, target, options).regenerate();
    }

    @Override
    public IChunkGet get(org.bukkit.World world, int chunkX, int chunkZ) {
        return new BukkitGetBlocks(world, chunkX, chunkZ);
    }

    @Override
    public int getInternalBiomeId(BiomeType biome) {
        BiomeBase base = CraftBlock.biomeToBiomeBase(MinecraftServer.getServer().getCustomRegistry().b(IRegistry.ay), com.sk89q.worldedit.bukkit.BukkitAdapter.adapt(biome));
